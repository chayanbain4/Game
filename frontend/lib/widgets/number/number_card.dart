// lib/widgets/number/number_card.dart
import 'dart:math';
...
class _NumberCardState extends State<NumberCard>
  ...
  final int _fakePlayers = 500 + Random().nextInt(700);
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              colors: [Color(0xFF4A1A1A), Color(0xFF2B0D0D), Color(0xFF220A0A)],
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: const Color(0xFFF87171).withOpacity(0.45),
                              blurRadius: 14,
                            ),
                          ],
                        ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(
                            color: const Color(0xFFF87171).withOpacity(0.20),
                            width: 0.8,
                          ),
                        ),
                        child: const Text(
