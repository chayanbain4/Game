// lib/widgets/superloto/superloto_card.dart
import 'dart:math';
import 'package:flutter/material.dart';

class SuperLotoCard extends StatefulWidget {
  const SuperLotoCard({super.key});

  @override
  State<SuperLotoCard> createState() => _SuperLotoCardState();
}

class _SuperLotoCardState extends State<SuperLotoCard>
    with SingleTickerProviderStateMixin {
  late AnimationController _ctrl;
  late Animation<double> _scale;

  final int _fakePlayers = 1000 + Random().nextInt(1500);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTapUp: (_) {
        _ctrl.reverse();
        Navigator.pushNamed(context, '/superloto');
      },
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              colors: [Color(0xFF3A2600), Color(0xFF221600), Color(0xFF160E00)],
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: const Color(0xFFFCD34D).withOpacity(0.20),
                            width: 0.8,
                          ),
                        ),
                        child: const Text(
                          '10-min draws, big prizes',
                          style: TextStyle(
